"""
Django settings for SilverTimes project.
...
INSTALLED_APPS = [
    ...
    "silvertimes.home",
    "silvertimes.images",
    "silvertimes.navigation",
    "silvertimes.news",
    "silvertimes.search",
    "silvertimes.standardpages",
    "silvertimes.users",
    "silvertimes.utils",
    "wagtail.embeds",
...
WSGI_APPLICATION = "silvertimes.wsgi.application"
